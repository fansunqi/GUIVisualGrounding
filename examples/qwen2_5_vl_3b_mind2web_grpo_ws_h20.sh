...
python3 -m verl.trainer.main \
    config=${CONFIG_PATH} \
    data.train_files=/root/cache/hub/datasets--fansunqi--mind2web_adapted/snapshots/a4a526d3b378f4edcdb8b13d8b6b0ad34546f74b/metadata/hf_train_ws_sim_0.7.json \
