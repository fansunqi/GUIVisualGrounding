...
EXP_NAME=combine_parquet_r1gui_org_grpo_qwen2_5_vl_3b_h20
...
python3 -m verl.trainer.main \
    config=${CONFIG_PATH} \
    data.train_files=${DATA_DIR}/metadata/hf_train_new_gui_r1_train_merge.parquet \
    data.val_files=${DATA_DIR}/metadata/hf_test_task.parquet \
    ...
    trainer.load_checkpoint_path=${SAVE_PATH}/global_step_150
