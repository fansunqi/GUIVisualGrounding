...
MODEL_PATH=/mnt/Shared_05_disk/fsq/hf_home/hub/models--ByteDance-Seed--UI-TARS-2B-SFT/snapshots/f366a1db3e7f29635f5b236d6a71dea367a0a700 # replace it with your local file path
SAVE_PATH=/mnt/Shared_05_disk/fsq/gui_agent_exp/gui-r1/mind2web_ws_grpo_ui_tars_2b_105
...
python3 -m verl.trainer.main \
    ...
    trainer.experiment_name=mind2web_ws_grpo_ui_tars_2b_105 \
