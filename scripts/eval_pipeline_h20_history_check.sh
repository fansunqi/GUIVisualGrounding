...
SAVE_NAME=mind2web_ws_org_sim_0_9_grpo_qwen2_5_vl_3b_h20
...
for ckpt_num in "${ckpt_numbers[@]}"; do
    ...
    python inference/inference_vllm_mind2web.py \
        ...
        --output_name ${SAVE_NAME}_global_step_${ckpt_num}_check \
        --num_actor 2 \
        --history_num 4 \
        --use_history
    python eval/eval_mind2web_point.py \
        --pred_path $OUTPUT_DIR/${SAVE_NAME}_global_step_${ckpt_num}_check/hf_test_full.json \
