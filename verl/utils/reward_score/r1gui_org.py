...
def r1gui_org_accuracy_reward(predict_str: str, ground_truth: str) -> float:
    """
...
def r1gui_org_compute_score(predict_str: str, ground_truth: str):
    format = r1gui_format_reward(predict_str)
    accuracy = r1gui_org_accuracy_reward(predict_str, ground_truth)
    return {
